...
def main():
    ...
    class spaceship(pygame.sprite.Sprite):
        ...
        def reset_rotation(self):
            """resets to the original image and copy to new direction/orientation""" 
    ...
    class Bullet(pygame.sprite.Sprite):
        ...
        def __init__(self, pos_shot, direction):
            ...
            self.image.fill(BLACK)
            self.image.set_colorkey(BLACK)
            # pygame.draw.circle(self.image, PINK, BULLET_SURFACE_CENTER , (4,4))
            pygame.draw.circle(self.image, PINK, (4,4) , 4)
